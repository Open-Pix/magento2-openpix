...
describe('openpix-boleto-method', () => {
  const file = path.resolve(
    __dirname,
    '../../Pix/view/frontend/web/js/view/payment/method-renderer/openpix-boleto-method.js',
  );
  ...
  it('provides getCode and getData', () => {
    ...
    const data = module.getData.call({ item: { method: 'openpix_boleto' } });
    expect(data).toEqual({ method: 'openpix_boleto' });
    expect(module.getCode()).toBe('openpix_boleto');
  });
});
